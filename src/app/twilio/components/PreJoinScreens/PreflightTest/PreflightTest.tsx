...
export function Result({
  ...
  if (networkCondition === NetworkCondition.Red) {
    return (
      <ResultItem icon={<ErrorIcon />}>
        Poor network conditions. You may experience poor call quality and
        reliability.
      </ResultItem>
    );
  }
...
export default function PreflightTest() {
  ...
  return (
    <Grid
      ...
      justify="center"
      alignItems="center"
      style={{ height: '55px', paddingBottom: '1.5em' }}
    >
